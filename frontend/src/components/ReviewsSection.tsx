...
export default function ReviewsSection({ reviews }: { reviews: Review[] }) {
    return (
        <section id="reviews" className="py-20 lg:py-28 bg-sand-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    {reviews.map((review, i) => (
                        <div
                            key={review.id}
                            className="bg-white rounded-2xl p-6 lg:p-8 shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-card-hover)] transition-all duration-500 hover:-translate-y-1 flex flex-col"
                        >
                            {/* Stars */}
                            <StarRating rating={review.rating} />

                            {/* Comment */}
                            <p className="text-slate-600 text-sm leading-relaxed mt-4 mb-6 flex-1">
